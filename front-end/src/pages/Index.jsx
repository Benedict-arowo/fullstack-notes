            ...
            <main className='w-full h-full pt-4 bg-blue-100'>
                ...
                <section className='mt-10 px-8 flex flex-col gap-4 items-center'>
                    <div className='bg-white text-gray-500 px-4 w-full py-2 h-40 rounded grid gap-y-2'>
                        ...
                        {/* Body */}
                        <p className='text-sm line-clamp-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid ullam cumque laborum praesentium iure quia modi officiis recusandae aliquam quibusdam. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae labore totam cum.</p>
