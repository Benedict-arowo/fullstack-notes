                ...
                <div className='w-full flex flex-col text-md max-w-xs'>
                    ...
                    <div className='w-full flex text-md max-w-xs flex-row items-center gap-2'>
                        ...
                        {passwordType === 'text' ?
                            ...
                            :
                            <svg onClick={(e) => togglePasswordView(e)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className='passwordIcon'>
